...
const Navbar = () => {
  ...
  return (
    <div className="py-5 text-lg font-medium flex items-center justify-between shadow-lg sticky top-0 bg-white">
      <a className="hover:text-blue-600" href="/">
        {" "}
        <h1 className="ml-10 text-2xl font-bold">Tushar Borul</h1>
      </a>
      {toggleNav ? (
